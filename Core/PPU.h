...
public:
	...
	uint16_t lowBGAttrShiftReg = 0; // For low bits of palette selection
	uint16_t highBGAttrShiftReg = 0; // For high bits of palette selection
	// Sprites
	std::array<uint8_t, 32> secondaryOAM; // Buffer for sprites on scanline
	int spritesFound = 0;
	int prevSpritesFound;
	uint8_t secondaryOAMBuffer;
	std::array<uint8_t, 8> lowSpriteShiftRegs;
